...
def load_config(path: Path | None = None) -> dict[str, Any]:
    ...
    required = {
        "max_frames",
        "multi_device_submaps",
        "submap_max_frames",
        "submaps_per_device",
        "submap_frames_per_capture",
        "alignment_max_images_per_submap",
        "alignment_feature_count",
        "alignment_ratio_test",
        "alignment_min_pair_matches",
        "alignment_max_image_pairs",
        "alignment_min_image_pairs",
        "alignment_ransac_threshold_ratio",
